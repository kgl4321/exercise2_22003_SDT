...
assignin(mdlWks, 'R_1', 26.53)
assignin(mdlWks, 'C_1', 320e-9)
...
ax1 = nexttile;
PlotSpectrum(V0, t_V0)
% title('Voltage spectrum V_1')
set(gca,'XScale','log','YScale','lin')
ylabel('|V_1(f)|','FontSize', 12)

% --- Current spectrum ---
ax2 = nexttile;
PlotSpectrum(I0,t_I0)
% title('Current spectrum I_1')
set(gca,'XScale','log','YScale','lin')
ylabel('|I_1(f)|','FontSize', 12)
